                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2 h-[60%] md:h-full p-8 flex flex-col overflow-y-auto">
                            ...
                            <p className="text-xl mb-6 font-light">
                                {product.originalPrice && <span className="line-through text-brand-brown/40 mr-3">{formatPrice(product.originalPrice)}</span>}
                            ...
                            <div className="flex flex-col gap-3 mt-auto">
                                <button
                                    onClick={handleAdd}
                                    disabled={isAdding}
                                    className="w-full bg-brand-brown text-brand-ivory py-4 text-xs font-semibold uppercase tracking-widest hover:bg-black transition-colors"
                                >
                                    {isAdding ? 'Adding...' : 'Add to Bag'}
                                </button>
                                <Link to="/#shop" onClick={onClose} className="w-full border border-brand-brown/20 text-brand-brown py-4 text-xs font-semibold uppercase tracking-widest text-center hover:bg-brand-brown/5 transition-colors">
                                    View Full Details
                                </Link>
                            </div>
                        </div>
